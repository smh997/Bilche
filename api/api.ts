  ...
  return {
    ...
    createFeedback: async (
      ...
      const needsSerialization =
        ...
        localVarRequestOptions.headers['Content-Type'] === 'application/json'
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(feedback !== undefined ? feedback : {})
        : feedback || ''
    ...
    createInstallapp: async (
      ...
      const needsSerialization =
        typeof installapp !== 'string' ||
        localVarRequestOptions.headers['Content-Type'] === 'application/json'
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(installapp !== undefined ? installapp : {})
        : installapp || ''
    ...
    createMyAuthToken: async (
      ...
      const needsSerialization =
        typeof myAuthToken !== 'string' ||
        localVarRequestOptions.headers['Content-Type'] === 'application/json'
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(myAuthToken !== undefined ? myAuthToken : {})
        : myAuthToken || ''
    ...
    createPasswordToken: async (
      ...
      const needsSerialization =
        ...
        localVarRequestOptions.headers['Content-Type'] === 'application/json'
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(passwordToken !== undefined ? passwordToken : {})
        : passwordToken || ''
    ...
    createSubscribe: async (
      ...
      const needsSerialization =
        typeof subscribe !== 'string' ||
        localVarRequestOptions.headers['Content-Type'] === 'application/json'
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(subscribe !== undefined ? subscribe : {})
        : subscribe || ''
    ...
    retrieveBasePlant: async (
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          'id',
          'Required parameter id was null or undefined when calling retrieveBasePlant.'
        )
      }
      const localVarPath = `/api/encyclopedia/plants/{id}/`.replace(
        `{${'id'}}`,
...
export const ApiApiFp = function (configuration?: Configuration) {
  return {
    ...
    async createEmail(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Email>
    > {
      const localVarAxiosArgs = await ApiApiAxiosParamCreator(
        configuration
      ).createEmail(email, options)
      return (
    ...
    async createFeedback(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Feedback>
    > {
      const localVarAxiosArgs = await ApiApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async createInstallapp(
      installapp?: Installapp,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Installapp>
    > {
      const localVarAxiosArgs = await ApiApiAxiosParamCreator(
        configuration
      ).createInstallapp(installapp, options)
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
     ...
     * @throws {RequiredError}
     */
    async createMyAuthToken(
      myAuthToken?: MyAuthToken,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<MyAuthToken>
    > {
      const localVarAxiosArgs = await ApiApiAxiosParamCreator(
        configuration
      ).createMyAuthToken(myAuthToken, options)
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    async createPasswordToken(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PasswordToken>
    > {
      const localVarAxiosArgs = await ApiApiAxiosParamCreator(
        configuration
      ).createPasswordToken(passwordToken, options)
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    async createSubscribe(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Subscribe>
    > {
      const localVarAxiosArgs = await ApiApiAxiosParamCreator(
        configuration
      ).createSubscribe(subscribe, options)
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    async retrieveBasePlant(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BasePlantObject>
    > {
      const localVarAxiosArgs = await ApiApiAxiosParamCreator(
        configuration
      ).retrieveBasePlant(id, options)
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
